...
def bbos(self):
		...
		print(Color.LR+"["+Color.LG+"01"+Color.LR+"]"+Color.LC+" Tool DdoS V1")
		print(Color.LR+"["+Color.LG+"02"+Color.LR+"]"+Color.LC+" Tool DDoS V2")
		print("\n")
		while True:
...
""")
		...
		print("\n")
		while True:
			sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"Vi Đức Hùng"+Color.LB+"@"+Color.LG+"Tool DDoS V1"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
			option = input()
			if option == '01' or option == '1':
				try:

...
""")
	...
	def bbos(self):
		...
		print(Color.LR+"["+Color.LG+"02"+Color.LR+"]"+Color.LC+" DDoS")
		print("\n")
		while True:
			sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"Vi Đức Hùng"+Color.LB+"-->"+Color.LG+"L4/L7/BBoS"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
			option = input()
			if option == '01' or option == '1':
